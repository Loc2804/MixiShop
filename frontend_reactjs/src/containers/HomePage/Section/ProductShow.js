...
class ProductShow extends Component {
    ...
    render() {
        ...
        listProduct = listProduct.slice(0,8);
        ...
        return (
            <div className='product-show-container container mt-3'>
                <div className='row product-show-body'>
                        ...
                        && listProduct.map((item,index) =>{
                            return (
                                <div className='col-3 info-product mt-3' key={index}>
                                    <div className='frm-img' onClick={() => this.showDetailProduct(item)}>
                                    ...
                                    <div className='name-product' onClick={() => this.showDetailProduct(item)}>
                                        {item.nameProduct}
                                    </div>
                    ...
                    <div className='col-12 display-all'>
                        <button className='btn btn-all' onClick={() => this.showAllProduct()}>XEM TẤT CẢ <i class="fas fa-chevron-right"></i></button>
                    </div>
                </div>
            </div>
